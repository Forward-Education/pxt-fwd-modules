namespace fwdSensors {
    ...
    export const enum MotionReg {
        ...
        /**
         * Constant ° uint16_t. Delay in ms between motion inactivity and inactivity event firing
         *
         * ```
         * const [angle] = jdunpack<[number]>(buf, "u16")
         * ```
    ...
    export namespace MotionRegPack {
        ...
        /**
         * Pack format for 'inactiveperiod' data.
         */
        export const InactivePeriod = "u16"
    ...
    export const enum MotionEvent {
        ...
        /**
         * No movement has been detected for *inactive period*.
         */
        //% block="inactive"
        Inactive = 0x2,
    }
